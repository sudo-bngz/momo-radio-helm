...
helm.sh/chart: {{ include "momo-radio.chart" . }}
{{ include "momo-radio.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "momo-radio.selectorLabels" -}}
app.kubernetes.io/name: {{ include "momo-radio.name" . }}
